...
logger = logging.getLogger("scc-adk")
...
def top_vulnerability_findings(
    project_id: str,
    max_findings: int = 10,
) -> Dict[str, Any]:
    ...
    max_findings (optional): The maximum number of findings to return. Defaults to 10.
    """
    if not scc_client:
    ...
    try:
        ...
        final_max_findings = max_findings if max_findings is not None and max_findings > 0 else 10
